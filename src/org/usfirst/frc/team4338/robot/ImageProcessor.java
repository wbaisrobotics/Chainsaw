...
public class ImageProcessor {
	...
	static double LONG_RATIO = 2.22; // Tote long side = 26.9 / Tote height =
										// 12.1 = 2.22;
	
	static double SCORE_MIN = 75.0; // Minimum score to be considered a tote
	
	static double SHORT_RATIO = 1.4; // Tote short side = 16.9 / Tote height =
										// 12.1 = 1.4;
	static double VIEW_ANGLE = 49.4; // View angle fo camera, set to Axis m1011
										// by default, 64 for m1013, 51.7 for
										// 206, 52 for HD3000 square, 60 for
										// HD3000 640x480
	
	// Default area minimum for particle as a percentage of total image area
	double AREA_MINIMUM = .5d;
	...
	NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(24, 49);
	// Default saturation range for yellow tote
	NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(67, 255);
	...
	static double TrapezoidScore(ParticleReport report) {
		return ratioToScore(report.convexHullArea / ((report.boundingRectRight - report.boundingRectLeft)
